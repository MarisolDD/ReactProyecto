      ...
      <div className="elegir5soles">
        <div className="row" >
          <div className="col" >
            ...
            continente. Aprovecha nuestras promociones de viaje y
            recorré el mundo entero. Comprá tu viaje en Despegar Argentina desde
            la web, la app o por Despegar teléfono. ¿Tenés dudas
          ...
          <div className="col">
            ...
            costo adicional por hacerio. También podés cancelar una
