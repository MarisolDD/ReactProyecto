  ...
  return (
    <div className="Body container-fluid">
      ...
      <div className="container-fluid text-center">
        <div className="row">
          <div className="col">
            ¿Por qué elegir Cinco Soles Turismo para tu viaje? Despegar es una
            de las agencias de viale con más trayectoria de Latinoamérica,
            reconocida y recomendada por miles de viajeros de todo el
            continente. Aprovecha nuestras ofertas y promociones de viaje y
            recorré el mundo entero. Comprá tu viaje en Despegar Argentina desde
            la web, la app o por Despegar teléfono: 0810 810 9994. ¿Tenés dudas
          ...
          <div className="col">
            ...
            para tus vacaciones muy fácilmente. Primero, ingresá la información
            de tu viaje en el buscador. Compará entre cientos de opciones y
            elegí la que más te guste desde el botón Comprar. Cargá los datos de
            los pasajeros, seleccioná tu medio de pago y completá la información
            requerida. ¡Aprovechá las promociones bancarias de Despegarl Por
          ...
          <div className="col">
            ...
            costo adicional por hacerio. En vuelos, hoteles y autos, solo podés
            hacer cambios con el mismo proveedor. También podés cancelar una
